module 0x1::pair_parameter_helper {
    ...
    public(package) fun get_max_volatility_accumulator(params: u256): u32 {
        ...
        max_volatility_accumulator = (encoded::decode_uint20(params, OFFSET_MAX_VOL_ACC) as u32);
    ...
    public(package) fun get_total_fee(params: u256, bin_step: u16): u128 {
        return safe_cast::safe128(((get_base_fee(params, bin_step) + get_variable_fee(params, bin_step))))
    }
