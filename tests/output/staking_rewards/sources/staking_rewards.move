module 0x1::staking_rewards {
    ...
    const E_INVALID_AMOUNT: u64 = 257u64;
    const E_REWARD_PERIOD_NOT_FINISHED: u64 = 258u64;
    const E_INSUFFICIENT_BALANCE: u64 = 259u64;
    const E_INVALID_USER: u64 = 260u64;
    const E_CANNOT_RECOVER_STAKING_TOKEN: u64 = 261u64;
    const E_CANNOT_RECOVER_REWARDS_TOKEN: u64 = 262u64;
